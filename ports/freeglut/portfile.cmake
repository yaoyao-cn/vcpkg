...
if(EXISTS "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/glut.pc")
    file(COPY_FILE "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/glut.pc" "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/freeglut.pc")
elseif(EXISTS "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/freeglut-gles.pc")
    file(COPY_FILE "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/freeglut-gles.pc" "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/freeglut.pc")
endif()
...
if(NOT VCPKG_BUILD_TYPE)
    ...
    if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/glut.pc")
        file(COPY_FILE "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/glut.pc" "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/freeglut.pc")
    elseif(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/freeglut-gles.pc")
        file(COPY_FILE "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/freeglut-gles.pc" "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/freeglut.pc")
    endif()
endif()
